    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-50 p-4 md:p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold font-spaceGrotesk mb-8 text-primary-500">Crea tu perfil</h1>
            ...
            <nav className="space-y-1">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  >
                    {currentStep > index ? <Check className="w-4 h-4" /> : <span>{index + 1}</span>}
                  </div>
                  <div className="flex flex-col">
                    <span className="font-medium font-spaceGrotesk">{step.name}</span>
                    <span className="text-sm text-muted-foreground font-inter">{step.description}</span>
                  </div>
                </div>
              ))}
            </nav>
