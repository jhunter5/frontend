        ...
        <div className="grid md:grid-cols-2 gap-8 h-full">
          ...
          <div className="p-8 md:p-16 flex flex-col justify-center max-w-xl mx-auto w-full">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Obten la{" "}
              <span className="text-[#27317E]">libertad</span>
              <br />
              con la que sueñas
            </h1>

            <p className="text-gray-600 mb-8">
              Gestiona tus propiedades y contratos con facilidad, automatiza los cobros y mantenimientos, y toma decisiones inteligentes con análisis de datos y IA.
            </p>
